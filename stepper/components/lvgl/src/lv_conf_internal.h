 ...
 *It removes the need to manually update the tick with `lv_tick_inc()`)*/
        ...
        #ifdef ESP_PLATFORM
            /* ESP-IDF: Use esp_timer for tick source */
            #define LV_TICK_CUSTOM_INCLUDE "esp_timer.h"
        #elif defined(CONFIG_LV_TICK_CUSTOM_INCLUDE)
        ...
        #ifdef ESP_PLATFORM
            /* ESP-IDF: Use esp_timer_get_time() converted to milliseconds */
            #define LV_TICK_CUSTOM_SYS_TIME_EXPR ((uint32_t)(esp_timer_get_time() / 1000LL))
        #elif defined(CONFIG_LV_TICK_CUSTOM_SYS_TIME_EXPR)
